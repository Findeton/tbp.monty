...
from tbp.monty.frameworks.utils.compositional_metrics import (  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Summarize compositional transfer metrics from eval_stats.csv"
    )
...
def main() -> int:
    ...
    taxonomy = load_compositional_taxonomy(args.taxonomy)
